            ...
            <template v-if="part.stt === stt">
                ...
                <figure
                    ...
                    <figure v-for="image in part.HinhanhWedding" :key="image.id" class="wp-block-image size-large"><span class='ns-pinterest-image'><img decoding="async"
                                width="1600" height="1065" data-id="25326"
                                :src="part.HinhanhWedding[0].duongDan"                                 alt="DSC 3453 - The Planners" class="wp-image-25326"
                                :data-lazy-src="image.duongDan"><noscript><img decoding="async"
                                    width="1600" height="1065" data-id="25326"
                                    src="/src/assets/wp-content/uploads/2023/10/DSC_3453.jpg" alt="DSC 3453 - The Planners"
                                    class="wp-image-25326"></noscript><span class='ns-pinterest-image-button ns-rounded'
                                data-novashare-href='https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftheplannersvn.com%2Fvi%2Fwedding-works%2Fballroom-wedding-in-hanoi-3%2F&media=https://theplannersvn.com/wp-content/uploads/2023/10/DSC_3453.jpg&description=Aurora%20Of%20Grace'
