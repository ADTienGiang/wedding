            ...
            <template v-if="part.stt === stt">
                ...
                <figure
                    ...
                    <figure v-for="image in part.HinhanhWedding" :key="image.id" class="wp-block-image size-large"><span class='ns-pinterest-image'><img decoding="async"
                                width="1065" height="1600" data-id="25382"
                                :src="part.HinhanhWedding[0].duongDan"                                 alt="DAT 4027 - The Planners" class="wp-image-25382"
                                :data-lazy-src="image.duongDan"><noscript><img
                                    decoding="async" width="1065" height="1600" data-id="25382"
                                    src="/src/assets/wp-content/uploads/2023/10/DAT_4027.jpg" alt="DAT 4027 - The Planners"
                                    class="wp-image-25382"></noscript><span class='ns-pinterest-image-button ns-rounded'
                                data-novashare-href='https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftheplannersvn.com%2Fvi%2Fwedding-works%2Fballroom-wedding-in-hanoi-3%2F&media=https://theplannersvn.com/wp-content/uploads/2023/10/DAT_4027.jpg&description=Aurora%20Of%20Grace'
