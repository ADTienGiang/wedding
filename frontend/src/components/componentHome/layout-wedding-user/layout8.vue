    ...
    <template v-if="weddingDetail">
        <template v-for="part in weddingDetail.part" :key="part.id">
            <template v-if="part.stt === stt">
                ...
                <figure
                    class="wp-block-gallery has-nested-images columns-default is-cropped wp-block-gallery-22 is-layout-flex wp-block-gallery-is-layout-flex">
                    <figure v-for="image in part.HinhanhWedding" :key="image.id" class="wp-block-image size-large"><span class='ns-pinterest-image'><img decoding="async"
                                width="1600" height="1065" data-id="25318"
                                :src="part.HinhanhWedding[0].duongDan"                                 alt="DAT 4666 - The Planners" class="wp-image-25318"
                                :data-lazy-src="image.duongDan"><noscript><img
                                    decoding="async" width="1600" height="1065" data-id="25318"
                                    src="/src/assets/wp-content/uploads/2023/10/DAT_4666.jpg" alt="DAT 4666 - The Planners"
                                    class="wp-image-25318"></noscript><span class='ns-pinterest-image-button ns-rounded'
                                data-novashare-href='https://pinterest.com/pin/create/button/?url=https%3A%2F%2Ftheplannersvn.com%2Fvi%2Fwedding-works%2Fballroom-wedding-in-hanoi-3%2F&media=https://theplannersvn.com/wp-content/uploads/2023/10/DAT_4666.jpg&description=Aurora%20Of%20Grace'
