    ...
    <div>
        ...
        <div v-for="(layout, index) in layouts" :key="index" class="image-layout">
            ...
            <div class="rectangle-container">
                <div class="image-preview hinhvuong" @click="() => handleImageClick(index, 'rectangle1')">
                    <img :src="layout.rectangle1" alt="Uploaded Image" class="uploaded-image" v-if="layout.rectangle1"/>
                    <div v-else class="image-placeholder rectangle">630x630</div>
                </div>
                <div class="image-preview hinhvuong" @click="() => handleImageClick(index, 'rectangle2')">
