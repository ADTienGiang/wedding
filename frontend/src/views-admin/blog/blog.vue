<template>
    ...
    <div class="form-container">
      <form @submit.prevent="submitForm">
        ...
        <div class="form-group">
          <label for="service">Giới thiệu blog:</label>
          <textarea rows="4" cols="50" type="text" id="service" v-model="gioithieu" class="form-input"
            placeholder="Nhập tên Giới thiệu về blog"></textarea>
        </div>
    ...
    <div class="banner-management">
      ...
      <a type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
        @click="setDefault"><i class="fa-solid fa-circle-plus"></i> <span>Thêm blog</span></a>
      <div class="form-container">
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <tr v-for="(wd, index) in service" :key="index">
                ...
                <td>
                  <div class="max-width-td"><img :src="wd.thumb" alt="Hình ảnh part"></div>
                </td>
                <td>
                  ...
                  <div class="image-container">
                    <div class="image-list">
                      <div class="image-item">
                        <img v-for="image in wd.hinhanhblog" :src="image.duongDan"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Thêm blog mới</h1>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="addBlog()">Thêm</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade modal" id="exampleModaledit" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Cập nhật blog</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="form-group">
            ...
            <div class="form-group row-content">
              ...
              <div class="d-flex hinhanhadminchinhsua">
                <img :src="selectedWedding.thumb" alt="Banner Wedding"
      ...
      async submitForm() {
        try {
          if (!this.filesArr) {
            ...
            const response = await this.$axios.post('addBannerContentBlog', formData, {
              headers: {
